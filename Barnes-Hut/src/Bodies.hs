...
colors = [G.greyN 0.5, G.violet, G.greyN 0.2, G.blue, G.red, G.orange, G.chartreuse, G.azure, G.cyan, G.magenta, G.greyN 0.2]

planets = zipWith4 fy' masses distances initVelocities colors

fy m d v c = B m (P d 1) (V 0 v) c (Just m) []
fx m d v c = B m (P 1 d) (V v 0) c (Just m) []
fy' m d v c = B m (P d 1) (V 0 v) c (Just 4.5) []

solarSystem = U ((125 * 0.4) / 152098232.0e3) 1 2000
                (sun:planets)
...
threeBodyCircle = U (500 / earthD) 1.17e-24 1000 bs' (makeBarnes w bs') False
  where masses          = [5.97e24, 1.989e30, 1.989e30]
        ...
        bs'             = [s1 { size = Nothing }, s2 { size = Nothing }, e]
          where s1 = bs !! 1
                s2 = bs !! 2
                e  = bs !! 0
        w               = 1.25e11
...
figureEight = U (500 / earthD) 1.33e-28 500 bs (makeBarnes w bs) False
